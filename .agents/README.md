...
- `2026-09-13-dynamic-worker-runtime-broker-completion-csm.json` — 2026-09-13 — plan (superseded by gap-remediation; built cycle 1: T004/T005 complete; T001 partial): 6 tasks — status: reference
- `2026-09-13-dynamic-worker-runtime-gap-remediation-csm.json` — 2026-09-13 — plan (in_progress, cycle 1; remediates ALL blockers + non-blockers from reviews A/B; independent critique applied; T001/T002/T003/T004/T005/T006/T008 built and verified; T007 delivery pending): 8 tasks — on-the-wire broker listener + limits separation, real drop source + observable capture policy, durability/reliability non-blockers, schema/registry owner + same-commit regen, mode-aware effective-isolation gate + live provider/broker wiring + telemetry, provider/policy honesty + listener-routed e2e + digest-bound attestation, decision gate + six-condition isolation matrix, durable delivery — status: reference
