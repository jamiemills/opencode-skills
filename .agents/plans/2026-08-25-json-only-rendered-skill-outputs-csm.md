...
3. [pending] Define shared envelopes, schema registry, artifact identity, journals, diagnostics, and render metadata.
   - Task ID: T003
   - Depends on: T002
   - Parallel group: G2
   - Risk: high
...
7. [pending] Build and verify the JSON-to-Markdown renderer.
   - Task ID: T007
   - Depends on: T006
   - Parallel group: G3
   - Risk: standard
...
8. [pending] Build and verify the direct JSON-to-HTML renderer.
   - Task ID: T008
   - Depends on: T006
   - Parallel group: G3
   - Risk: high
...
9. [pending] Implement publication, interaction-mode, approval, transient export, and projection-discovery boundaries.
   - Task ID: T009
