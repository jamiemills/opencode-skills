...
const EMOJI_RE =
  /^[\u{1F300}-\u{1F9FF}\u{2600}-\u{27BF}\u{1F600}-\u{1F64F}\u{1F680}-\u{1F6FF}\u{1F900}-\u{1F9FF}]/u;
...
export async function scan(repoPath, overview, broker = commandBroker) {
  ...
  const hasIssueTemplates =
    existsSync(issueTemplateDir) || existsSync(join(repoPath, ".github/ISSUE_TEMPLATE.md"));
