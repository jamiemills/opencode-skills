...
| Envelope trust    | fixed package policy, no envelope path/exec fields, steps denylist, steps never executed, machine-readable `signed` verify-output marker (true only when Ed25519 verification ran and passed)                                                                                                                  | trust-root establishment and approval          |
