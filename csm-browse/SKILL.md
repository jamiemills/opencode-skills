---
name: csm-browse
description: browse web pages in the chromium-vnc Docker container via CDP: navigate, click, type, log in, screenshot, inspect DOM/code, capture console/network/performance, record videos
---
