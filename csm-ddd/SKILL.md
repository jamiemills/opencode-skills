...
and treat conflicts toward repository evidence. A NORMS.md is trusted only if
it reads like authentic scan output (markers such as "Generated by csm-scan"
or a Repository Overview section); otherwise note it and continue. Absent or
