...
- Never include credentials, private keys, tokens, or personal data in the finding, its artifacts, or temp-dir evidence; redact before quoting; re-check at VERIFY and before the optional commit.
