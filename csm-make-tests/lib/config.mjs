...
export const SKILL_NAME = "csm-make-tests";
export const CONFIG_SCHEMA_ID = "csm-make-tests-config/1";
export const DEFAULT_CONFIG = Object.freeze({
  testDimensions: ["characterization", "property", "contract", "performance"],
  maxFiles: 100,
});
...
export function resolveSkillConfig(effectiveConfig) {
  ...
  if (namespace === undefined || (isPlainObject(namespace) && Object.keys(namespace).length === 0))
    return {
      config: Object.freeze({
        ...DEFAULT_CONFIG,
        testDimensions: Object.freeze([...DEFAULT_CONFIG.testDimensions]),
      }),
  ...
  const merged = { ...DEFAULT_CONFIG, ...namespace };
  return {
    config: Object.freeze({
      ...merged,
      testDimensions: Object.freeze([...merged.testDimensions]),
    }),
    schema: CONFIG_SCHEMA_ID,
    source: "configured",
  };
