...
export const SKILL_NAME = "csm-review-python";
export const CONFIG_SCHEMA_ID = "csm-review-python-config/1";
export const DEFAULT_CONFIG = Object.freeze({ mode: "static" });
