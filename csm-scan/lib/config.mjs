...
export const SKILL_NAME = "csm-scan";
export const CONFIG_SCHEMA_ID = "csm-scan-config/1";
export const DEFAULT_CONFIG = Object.freeze({ maxRetries: 2, outputFormat: "json" });
